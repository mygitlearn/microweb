...
<body>
    ...
    <div id="main-content">
		...
		<div id="pic">
			<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="pic_info">
					<div class="img_delete">
						<div class="pic_img">
							<img src="<?php echo '/microweb/Uploads/'; echo ($vo["savepath"]); ?>/<?php echo ($vo["savename"]); ?>">
						</div>
		...
		<input type="hidden" id="addr" value="<?php echo U('editimg');?>">
		<input type="hidden" id="delete" value="<?php echo U('delimg');?>">
		<!-- <div id="hint"></div> -->
