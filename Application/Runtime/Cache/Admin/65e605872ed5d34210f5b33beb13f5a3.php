...
<body>
	...
	<div class="cf">
		<div class="fl">
            ...
            <!-- <button class="btn ajax-post" url="<?php echo U('changeStatus');?>" target-form="ids">启 用</button> -->
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<input type="text" name="nickname" class="search-input" value="<?php echo I('nickname');?>" placeholder="请输入账号/昵称/ID">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td id="td_email"><?php echo ($vo["email"]); ?></td>
			<td><?php if(($vo["forbidden"]) == "0"): ?><a href="<?php echo U('User/changeStatus?method=forbidUser&id='.$vo['id']);?>" class="ajax-get deal" style="color:red">禁用</a>
				<?php else: ?>
				<a href="<?php echo U('User/changeStatus?method=resumeUser&id='.$vo['id']);?>" class="ajax-get deal" style="color:green">启用</a><?php endif; ?>&emsp;
				<!-- <a href="<?php echo U('AuthManager/group?uid='.$vo['uid']);?>" class="authorize">授权</a> -->
                <a href="<?php echo U('User/changeStatus?method=deleteUser&id='.$vo['id']);?>" class="confirm ajax-get deal">删除</a>
            </td>
