...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>微站管理系统</title>
        <link rel="stylesheet" type="text/css" href="/microweb/Public/Admin/css/login.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
       ...
       $(document).ready(function(){
        ...
        $("form").submit(function(e){
            ...
            function success(data){
                if(data == 1){
                    window.location.href = "/microweb/index.php/Admin/Index/index.html";
                }else{
                    $('#notice').html(data);
                    $(".reloadverify").click();
                }
