...
<body>
    ...
    <tbody>
		<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('details?seat='.$vo['user_id']);?>"><?php echo ($vo["account"]); ?></a></td>
			<td><a href="<?php echo U('details?seat='.$vo['user_id']);?>"><?php echo ($vo["nickname"]); ?></a></td>
			<td>
				<?php if(($vo['way']) == "0"): ?><label style="color:red">待回复</label><?php else: ?><label style="color:green">已回复</label><?php endif; ?></td>
